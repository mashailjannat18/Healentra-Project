...
import LeftImage from '@/assets/heroMainImg.svg';
import { loginForm } from '@/formik/forms/auth';
import { loginValidationSchema } from '@/formik/validations/auth';
import { loginInitialValues } from '@/formik/initial-values/auth'
...
export default function Login() {
    ...
    const { handleLogin, isLoading, error, resetError } = useAuth();
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className="flex flex-col lg:flex-row min-h-screen">
                <div className="lg:w-1/2 w-full min-h-[50vh] lg:min-h-screen p-5 sm:p-8 md:p-10 lg:p-12 xl:p-16 flex flex-col justify-center order-1 lg:order-1">
                    <div className="max-w-md mx-auto w-full">
                        <div className="mb-8 sm:mb-10">
                            <Image
                                ...
                                height={36}
                                width={120}
                                className="object-contain w-auto h-8 sm:h-9 md:h-10 mb-8 sm:mb-10 lg:mb-12"
                            />
                            ...
                            <p className="text-gray-600 text-sm sm:text-base">
                                ...
                                <a href="/auth/signup" className="text-cyan-500 hover:text-cyan-600 font-medium transition-colors">
                                    Create now
                                </a>
                            </p>
                        </div>
                ...
                <div className="lg:w-1/2 w-full min-h-[50vh] lg:min-h-screen bg-[#001439] p-5 sm:p-8 md:p-10 lg:p-12 xl:p-16 flex flex-col justify-center items-center text-white relative overflow-hidden order-2 lg:order-2">
                    ...
                    <div className="text-center max-w-xs sm:max-w-sm lg:max-w-md mx-auto">
                        ...
                        <p className="text-white/80 text-xs sm:text-sm lg:text-base leading-relaxed">
                            Cut Documentation Time by 70% with Healentra AI Note Assist — AI-powered notes that improve accuracy and keep you HIPAA compliant.
                        </p>
                    </div>
                </div>
            </div>
